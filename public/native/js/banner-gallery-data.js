// Banner Gallery Data
// Categories with display names and counts
...
function getBannersForCategory(categoryId) {
...
function searchCategories(query) {
  ...
  return BANNER_CATEGORIES.filter(cat => {
...
function getCategoryById(id) {
  return BANNER_CATEGORIES.find(c => c.id === id);
}
