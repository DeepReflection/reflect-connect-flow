...
export const THEMES: Theme[] = [
  ...
  // Business Themes (Dark) - Each with unique layout
  { id: 'corporate-navy', name: 'Corporativo Marinho', description: 'Azul marinho profissional e confiável', layout: 'corporate' },
  { id: 'executive-charcoal', name: 'Executivo Carvão', description: 'Cinza escuro sofisticado e moderno', layout: 'executive' },
  { id: 'startup-teal', name: 'Startup Teal', description: 'Verde-azulado inovador e dinâmico', layout: 'startup' },
  { id: 'finance-green', name: 'Finanças Verde', description: 'Verde clássico de prosperidade', layout: 'finance' },
  { id: 'consulting-slate', name: 'Consultoria Ardósia', description: 'Azul-cinza elegante e confiável', layout: 'consulting' },
  { id: 'tech-indigo', name: 'Tech Índigo', description: 'Azul-violeta tecnológico e futurista', layout: 'tech' },
  { id: 'luxury-black', name: 'Luxo Preto', description: 'Preto premium com dourado sutil', layout: 'luxury' },
  { id: 'modern-graphite', name: 'Grafite Moderno', description: 'Cinza neutro contemporâneo', layout: 'graphite' },
  { id: 'innovation-blue', name: 'Inovação Azul', description: 'Azul elétrico vibrante e criativo', layout: 'innovation' },
  { id: 'prestige-burgundy', name: 'Prestígio Borgonha', description: 'Vermelho vinho elegante e exclusivo', layout: 'prestige' },
  // Light Themes
