...
const BlogEdit = () => {
  ...
  const handleSave = (data: Partial<BlogPost>) => {
    console.log('Dados atualizados do artigo:', data);
    ...
    alert(`Substitua o artigo no arquivo src/data/blogPosts.ts com este código:\n\n${codeToUpdate}`);
  };
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Modifique os campos abaixo para atualizar o artigo.
          </p>
        </motion.div>
